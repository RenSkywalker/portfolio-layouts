...
<p className="text-lg md:text-2xl text-gray-500 max-w-3xl mx-auto mb-10">
...
href={p.url}
target="_blank"
className="bg-gray-100 h-48 md:h-56 rounded-xl flex items-center justify-center font-semibold hover:scale-105 transition"
>
{p.name}
</a>
))}
...
<button className="bg-black text-white px-6 md:px-8 py-3 md:py-4 rounded-lg">
Solicitar orçamento
</button>
