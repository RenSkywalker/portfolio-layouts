...
<button className="bg-blue-600 px-12 py-5 rounded-lg text-xl">
...
<h3 className="text-3xl text-gray-300 mb-16">
Empresas que utilizam nossa tecnologia
</h3>

<div className="flex flex-wrap justify-center gap-20 text-xl">

<div className="flex items-center gap-4 text-blue-400">
<Layers size={50}/>
<span className="text-2xl font-semibold">TechCorp</span>
</div>

<div className="flex items-center gap-4 text-purple-400">
<Cloud size={50}/>
<span className="text-2xl font-semibold">FutureLabs</span>
</div>

<div className="flex items-center gap-4 text-green-400">
<Users size={50}/>
<span className="text-2xl font-semibold">NovaDigital</span>
</div>

<div className="flex items-center gap-4 text-yellow-400">
<ShieldCheck size={50}/>
<span className="text-2xl font-semibold">CloudWare</span>
</div>
...
<section className="py-28 px-16 text-center">
...
<div className="bg-gray-900 rounded-xl p-16 max-w-5xl mx-auto">
...
<h3 className="text-4xl font-bold">$82k</h3>
</div>
...
<section className="grid md:grid-cols-3 gap-12 px-20 py-28 text-center">

<div className="bg-gray-900 p-10 rounded-xl">
<Cloud size={50} className="mx-auto mb-6 text-blue-400"/>
<h3 className="text-2xl font-semibold mb-4">Infraestrutura Cloud</h3>
...
<h3 className="text-2xl font-semibold mb-4">Analytics Inteligente</h3>
<p className="text-gray-400 text-lg">
...
<h3 className="text-2xl font-semibold mb-4">Automação</h3>
<p className="text-gray-400 text-lg">
